document.addEventListener('DOMContentLoaded', () => {
    ...
    const gameData = [
        ...
        { word: 'שׁוּעָל', emoji: '🦊' },
        { word: 'פַּנְדָּה', emoji: '🐼' },
        { word: 'דֹּב', emoji: '🐻' },
        { word: 'זֶבְּרָה', emoji: '🦓' },
        { word: 'גִ\'ירָפָה', emoji: '🦒' },
        { word: 'תַּנִּין', emoji: '🐊' },
        { word: 'צָב', emoji: '🐢' },
        { word: 'לִוְיָתָן', emoji: '🐳' },
        { word: 'דּוֹלְפִין', emoji: '🐬' },
        { word: 'הַמְבּוּרְגֵּר', emoji: '🍔' },
        { word: 'צִ\'יפְּס', emoji: '🍟' },
        { word: 'סֻפְגָּנִיָּה', emoji: '🍩' },
        { word: 'עוּגִיָּה', emoji: '🍪' },
        { word: 'שׁוֹקוֹלָד', emoji: '🍫' },
        { word: 'סֻכָּרִיָּה', emoji: '🍭' },
        { word: 'פּוֹפְּקוֹרְן', emoji: '🍿' },
        { word: 'בֵּיצָה', emoji: '🥚' },
        { word: 'לֶחֶם', emoji: '🍞' },
        { word: 'חוּלְצָה', emoji: '👕' },
        ...
        { word: 'כְּפָפָה', emoji: '🧤' },
        { word: 'צָעִיף', emoji: '🧣' },
        { word: 'מִשְׁקָפַיִם', emoji: '👓' },
        { word: 'כֶּתֶר', emoji: '👑' },
        { word: 'קֶשֶׁת', emoji: '🌈' },
        { word: 'הַר גַּעַשׁ', emoji: '🌋' },
        { word: 'גַּל', emoji: '🌊' },
        { word: 'יָרֵחַ', emoji: '🌙' },
        { word: 'שֶׁלֶג', emoji: '❄️' },
        { word: 'אֵשׁ', emoji: '🔥' },
        ...
        { word: 'בָּרָק', emoji: '⚡' },
        { word: 'סוּפָה', emoji: '🌪️' },
        { word: 'גִּיטָרָה', emoji: '🎸' },
        { word: 'פְּסַנְתֵּר', emoji: '🎹' },
        { word: 'חֲצוֹצְרָה', emoji: '🎺' },
        { word: 'כִּנּוֹר', emoji: '🎻' },
        { word: 'תֹּף', emoji: '🥁' },
        { word: 'טֶלֶפוֹן', emoji: '📱' },
        { word: 'מַחְשֵׁב', emoji: '💻' },
        { word: 'טֶלֶוִיזְיָה', emoji: '📺' },
        { word: 'נוּרָה', emoji: '💡' },
        { word: 'יַהֲלוֹם', emoji: '💎' },
        { word: 'רוֹבּוֹט', emoji: '🤖' }
    ];
